...
final class ImageRecord
{
    ...
    public function __construct(
        /** @var ?string */
        public readonly ?string $imageURL50,

        /** @var string */
        public readonly string $imageURL100,

        /** @var string */
        public readonly string $imageURL200,

        /** @var string */
        public readonly string $imageURL400,

        /** @var string */
        public readonly string $imageURL800,

        /** @var ?string */
        public readonly ?string $imageURL1600,
    ) {
    }
