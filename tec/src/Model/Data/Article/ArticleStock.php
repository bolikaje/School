...
final class ArticleStock
{
     ...
     * @param ?float $weight
     * @param ArticleStockPrice $prices
     */
    public function __construct(
        /** @var int */
        public readonly int $tecdocSupplierId,

        /** @var int */
        public readonly int $minimumOrderQuantity,

        /** @var int */
        public readonly bool $enforceQuantityMultiple,
        ...
        /** @var ArticleStockPrice */
        public readonly ArticleStockPrice $prices,
    ) {
    }
}
