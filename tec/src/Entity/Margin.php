...
class Margin extends \ObjectModel
{
    /** @var int */
    public $id;
    ...
    public static $definition = [
        'table' => DatabaseConstant::TECDOC_MARGIN_TABLE,
        'primary' => 'id_tecdoc_margin',
        'fields' => [
            ...
            'margin' => ['type' => self::TYPE_FLOAT, 'validate' => 'isFloat', 'size' => 20, 'required' => true],
