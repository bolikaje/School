 ...
 * @ORM\Table()
 *
 * @ORM\Entity(repositoryClass="ItPremium\TecDoc\Repository\MarginRepository")
 */
class TecdocMargin implements TecdocEntityWithRateInterface
{
    /**
     * @var int
     *
     * @ORM\Id
     *
     * @ORM\Column(name="id_tecdoc_margin", type="integer")
     *
     ...
     * @var TecdocSupplier
     *
     * @ORM\ManyToOne(targetEntity="TecdocSupplier", inversedBy="tecdocMargins")
     *
     ...
     * @var float
     *
     * @ORM\Column(name="margin", type="float", length=25)
     */
    ...
    /**
     * The group ID does not exist for margin records
     *
     * @return ?int
     */
