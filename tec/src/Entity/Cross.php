...
class Cross extends \ObjectModel
{
    /** @var int */
    public $id;
    ...
    public static $definition = [
        'table' => DatabaseConstant::TECDOC_CROSS_TABLE,
        'primary' => 'id_tecdoc_cross',
        'fields' => [
            ...
            'cross_brand' => ['type' => self::TYPE_STRING, 'validate' => 'isString', 'size' => 255, 'required' => true],
            'cross_reference' => ['type' => self::TYPE_STRING, 'validate' => 'isString', 'size' => 255, 'required' => true],
