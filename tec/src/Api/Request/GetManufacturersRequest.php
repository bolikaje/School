...
class GetManufacturersRequest extends AbstractTecDocRequest
{
    /**
     * @var string
     */
     ...
     * @var bool
     */
    protected bool $countryGroupFlag = false;
     ...
     * @return bool
     */
    public function isCountryGroupFlag(): bool
    {
     ...
     * @return $this
     */
    public function setCountryGroupFlag(bool $countryGroupFlag): static
    {
