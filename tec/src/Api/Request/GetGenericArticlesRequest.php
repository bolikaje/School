...
class GetGenericArticlesRequest extends AbstractTecDocRequest
{
    /**
     * @var string
     */
     ...
     * @var bool
     */
    protected bool $searchTreeNodes;
     ...
     * @return bool
     */
    public function getSearchTreeNodes(): bool
    {
     ...
     * @return $this
     */
    public function setSearchTreeNodes(bool $searchTreeNodes): static
    {
